...
public class ThemCauHoiVideo {
    ...
    @DataProvider(name = "duLieuVideo")
    public Object[][] getData() {
        JSONArray data = DocFileJSON.docDuLieuJSON("resources/them_cau_hoi_video.json");
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            testData[i][2] = json.get("idVideo") != null ? json.get("idVideo").toString() : "";
    ...
    @Test(dataProvider = "duLieuVideo")
    public void TC_ThemCauHoiVideo(String tenBaiTap, String tenFileAnhBia, String idVideo, String noiDungCauHoi, JSONArray cauTraLoiList, int indexDapAnDung) throws InterruptedException {
        ...
        baiTapPage.chonLoaiVideo();
        baiTapPage.clickMoRongCauHoi(0); 

        // Nhập ID Video
        baiTapPage.enterIdVideo(idVideo);
        ...
        inKetQuaConsole("ID Video", idVideo, idVideo);
        ...
        System.out.println("--> THÊM BÀI TẬP VIDEO THÀNH CÔNG!\n");
    }
